...
const _i18n = {
  ja: {
    ...
    'submit.yt_keep_title':'既存の動画リンクを残しますか？',
    'submit.yt_keep_desc':'今回の投稿には動画リンクが含まれていません。',
    'submit.yt_keep_yes':'残す','submit.yt_keep_no':'削除する',
    ...
    'rate.btn':'レートランキング',
    'submit.yt_url':'YouTube動画URL（任意）','submit.yt_hint':'YouTubeのURLのみ入力できます。同属性のスコアを更新する場合、新しい動画を入力しなければ以前の動画リンクをそのまま残せます',
  ...
  zh: {
    ...
    'submit.yt_keep_title':'是否保留現有的影片連結？',
    'submit.yt_keep_desc':'本次投稿未包含影片連結。',
    'submit.yt_keep_yes':'保留','submit.yt_keep_no':'刪除',
    ...
    'rate.btn':'評分排行榜',
    'submit.yt_url':'YouTube影片網址（選填）','submit.yt_hint':'僅限YouTube網址。更新同屬性分數時，若不輸入新影片，可保留之前的影片連結',
