...
const _i18n = {
  ja: {
    ...
    'chat.title':'掲示板','chat.subtitle':'属性ごとに相談できる掲示板です','chat.placeholder':'メッセージを入力','chat.empty':'まだメッセージがありません','chat.delete':'削除',
  ...
  zh: {
    ...
    'chat.title':'留言板','chat.subtitle':'依屬性分類的討論留言板','chat.placeholder':'輸入訊息','chat.empty':'目前還沒有訊息','chat.delete':'刪除',
